...
public class RESTDocsGenerator extends org.neo4j.doc.tools.AsciiDocGenerator
{
    ...
    private <T extends ClientRequest.Builder> T withHeaders(T builder) {
        for (Map.Entry<String, String> entry : addedRequestHeaders.entrySet()) {
                                                ...
                                                final Collection<String> additionalFilter )
    {
        ...
        for ( Map.Entry<String, List<T>> header : headers.entrySet() )
        {
    ...
    protected void document( final DocumentationData data )
    {
        ...
        try ( Writer fw = org.neo4j.doc.tools.AsciiDocGenerator.getFW( dir, filename ) )
        {
            ...
            fw.append( org.neo4j.doc.tools.AsciiDocGenerator.dumpToSeparateFile( dir, name
                            + ".request",
                    sb.toString() ) );
