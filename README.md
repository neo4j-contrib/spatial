...
* Using GeoTools 14.4 (for GeoServer 2.8.4):
  ...
  * [v0.25.3 for Neo4j 3.3.1](https://github.com/neo4j-contrib/m2/blob/master/releases/org/neo4j/neo4j-spatial/0.25.3-neo4j-3.3.1/neo4j-spatial-0.25.3-neo4j-3.3.1-server-plugin.jar?raw=true)
...
~~~xml
    ...
    <dependency>
        <groupId>org.neo4j</groupId>
        <artifactId>neo4j-spatial</artifactId>
        <version>0.25.3-neo4j-3.3.1</version>
    </dependency>
~~~
