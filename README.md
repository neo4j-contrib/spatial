...
* [for Neo4j 3.0.4 using GeoTools 14.4](https://github.com/neo4j-contrib/m2/blob/master/releases/org/neo4j/neo4j-spatial/0.22-neo4j-3.0.4/neo4j-spatial-0.22-neo4j-3.0.4-server-plugin.jar?raw=true)
