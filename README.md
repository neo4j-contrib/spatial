...
* [for Neo4j 3.0.2](https://github.com/neo4j-contrib/m2/blob/master/releases/org/neo4j/neo4j-spatial/0.17-neo4j-3.0.2/neo4j-spatial-0.17-neo4j-3.0.2-server-plugin.jar?raw=true)
