...
* Using GeoTools 14.4 (for GeoServer 2.8.4):
  ...
  * [v0.25.5 for Neo4j 3.4.1](https://github.com/neo4j-contrib/m2/blob/master/releases/org/neo4j/neo4j-spatial/0.25.5-neo4j-3.4.1/neo4j-spatial-0.25.5-neo4j-3.4.1-server-plugin.jar?raw=true)
