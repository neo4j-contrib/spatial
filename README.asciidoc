...
* unzip the +target/xxxx-server-plugin.zip+ and the Neo4j libraries from your Neo4j download under +NEO4J_HOME/bli+ into $GEOSERVER_HOME/webapps/geoserver/WEB-INF/lib
